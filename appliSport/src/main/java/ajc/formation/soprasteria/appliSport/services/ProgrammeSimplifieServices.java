...
import ajc.formation.soprasteria.appliSport.repositories.ProgrammeSimplifieRepository;

@Service
public class ProgrammeSimplifieServices{
	
	@Autowired
	private ProgrammeSimplifieRepository programmeRepo;
