...
import ajc.formation.soprasteria.appliSport.services.ProgrammeSimplifieServices;

@RestController
@RequestMapping("/api/programmeSimple")
public class ProgrammeSimplifieRestController {
	
	@Autowired
	private ProgrammeSimplifieServices programmeSrv;
